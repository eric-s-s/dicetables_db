...
#     def setUp(self):
#         self.connection.reset_table()
#         self.injector = interface.ConnectionCommandInterface(self.connection)
#
#     def tearDown(self):
#         del self.injector
#
#     def test_InMemoryInformation_init_empty(self):
#         info = interface.InMemoryInformation(self.connection)
...
#         self.connection.cursor.execute('alter table master add column [Die(1)] INTEGER DEFAULT 0')
#         self.assertTrue(interface.InMemoryInformation(self.connection).has_die_column('Die(1)'))
#
#     def test_InMemoryInformation_has_die_column_false(self):
#         self.connection.cursor.execute('alter table master add column [Die(1)] INTEGER DEFAULT 0')
#         self.assertFalse(interface.InMemoryInformation(self.connection).has_die_column('Die(2)'))
#
#     def test_InMemoryInformation_has_table_true(self):
#         self.assertTrue(interface.InMemoryInformation(self.connection).has_table('master'))
#
#     def test_InMemoryInformation_has_table_false(self):
#         self.assertFalse(interface.InMemoryInformation(self.connection).has_table('nonsense'))
#
