...
#
# """
# this is a gross gross misuse of unittest and testing.
#
# problem: easily find which tests failed in module that inherit from test_baseconnection.py
#
# solution: run a test case that isn't a test case. it searches the files in tests/connections.
...
#
# i will now stand back as i bask in your adulation at my fugly approach. <bows>
# """
#
#
...
#
#         self.write_lines('test_baseconnection.py', with_numbers)
#
#         for file_name in os.listdir('connections'):
#             if file_name != 'test_baseconnestion.py':
#                 self.copy_numbered_names(file_name, no_numbers, with_numbers)
#
#     def copy_numbered_names(self, file_name, no_numbers, with_numbers):
